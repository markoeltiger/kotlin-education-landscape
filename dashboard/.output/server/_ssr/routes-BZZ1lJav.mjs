...
import { t as Route } from "./routes--xH1wOoB.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BZZ1lJav.js
...
var DataTable = (0, import_react.lazy)(() => import("./DataTable-CCZb1rl8.mjs").then((m) => ({ default: m.DataTable })));
function Dashboard() {
