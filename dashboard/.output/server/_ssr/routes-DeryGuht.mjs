...
import { t as Route } from "./routes-C49qveDM.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DeryGuht.js
...
function ActiveFilters({ filters, setFilters }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [chips.map((c, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			className: "mono text-[11px] px-2 py-1 rounded-md bg-[color:var(--kt-orange)]/15 text-[color:var(--kt-orange)] hover:bg-[color:var(--kt-orange)]/25",
			children: "clear all"
		})]
	});
}
...
var DataTable = (0, import_react.lazy)(() => import("./DataTable-BHhYvnua.mjs").then((m) => ({ default: m.DataTable })));
function Dashboard() {
