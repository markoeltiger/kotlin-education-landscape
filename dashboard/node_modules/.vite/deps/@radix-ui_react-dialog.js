	...
	for (const propName in childProps) {
		...
		if (/^on[A-Z]/.test(propName)) {
			if (slotPropValue && childPropValue) {
				...
				if (!slotIsFunction || !childIsFunction) console.warn(`Slot: Expected a function for ${propName}, but received ${[typeof slotPropValue, typeof childPropValue].filter((v) => v !== "function").join(" and ")}.`);
