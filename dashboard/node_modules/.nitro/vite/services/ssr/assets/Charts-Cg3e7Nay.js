...
function Histogram({ values, bins = 10, height = 200, color = "#7F52FF" }) {
	...
	useEffect(() => {
		...
		const hist = d3.bin().domain([0, 1]).thresholds(thresholds)(values);
		...
		const xAxis = d3.axisBottom(x).tickValues(midpoints).tickFormat((v) => v.toFixed(1)).tickSizeOuter(0);
...
function MoocCourseTable({ courses }) {
	if (!courses.length) return /* @__PURE__ */ jsx(Empty, {});
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("table", {
			...
			}), /* @__PURE__ */ jsx("tbody", { children: courses.map((c, i) => /* @__PURE__ */ jsxs("tr", {
...
//#endregion
export { HorizontalBars as a, useResizeObserver as c, classNames as d, fmt as f, Histogram as i, Empty as l, Funnel as n, MoocCourseTable as o, GitHubRepoBars as r, StackedBars as s, Donut as t, Panel as u };
