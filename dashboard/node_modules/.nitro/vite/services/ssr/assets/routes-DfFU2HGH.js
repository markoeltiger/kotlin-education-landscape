import { a as HorizontalBars, c as useResizeObserver, d as classNames, f as fmt, i as Histogram, n as Funnel, o as MoocCourseTable, r as GitHubRepoBars, s as StackedBars, t as Donut, u as Panel } from "./Charts-Cg3e7Nay.js";
import { applyFilters, emptyFilters, groupBy, topN } from "./dataset-DEQaWqwR.js";
import { t as Route } from "./routes-C0R5OHaN.js";
...
function FilterRail({ filters, setFilters, sources, countries, filteredCount, totalCount }) {
	...
	const filterContent = /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx(Group, {
				...
				children: /* @__PURE__ */ jsx(ToggleRow, { children: TIERS.map((t) => /* @__PURE__ */ jsx(Chip, {
	...
	const mobileFilterContent = /* @__PURE__ */ jsxs("div", {
...
function Group({ label, tooltip, children }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [label, tooltip && /* @__PURE__ */ jsx("span", {
				title: tooltip,
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: [
			...
			children: [
				...
				it.isPrimary && /* @__PURE__ */ jsxs("div", {
					...
					}), it.secondary !== void 0 && /* @__PURE__ */ jsxs("span", {
						className: "mono text-[10px] sm:text-[11px] tabular-nums text-muted-foreground",
						children: [
							"+ ",
							/* @__PURE__ */ jsx(CountUp, { value: it.secondary }),
							" ",
							/* @__PURE__ */ jsx("span", {
...
//#endregion
//#region src/components/InsightSummary.tsx
...
//#endregion
//#region src/components/ChartInsight.tsx
...
var DataTable = lazy(() => import("./DataTable-DikFHMl3.js").then((m) => ({ default: m.DataTable })));
function SectionDivider({ label, description }) {
	return /* @__PURE__ */ jsxs("div", {
		className: "flex items-center gap-4 pt-2 sm:pt-4",
		children: [
			/* @__PURE__ */ jsx("div", { className: "flex-1 h-px bg-line" }),
			/* @__PURE__ */ jsxs("div", {
...
function Dashboard() {
	...
	const moocCounts = useMemo(() => topN(groupBy(filtered.filter((r) => r.source === "stepik" || r.source === "coursera"), (r) => r.source), 10), [filtered]);
	useMemo(() => {
	...
	const mapRows = useMemo(() => filtered.filter((r) => r.source === "university_website"), [filtered]);
		...
		children: [/* @__PURE__ */ jsxs("header", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx(DatasetTimestamp, { generatedAt: dataset.meta.generated_at })
				})
			]
		}), /* @__PURE__ */ jsxs("div", {
				...
				/* @__PURE__ */ jsxs("main", {
					...
					children: [
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx(ActiveFilters, {
								filters,
								setFilters
							})
						}),
						/* @__PURE__ */ jsx(InsightSummary, { insight: dataset.insights?.overall }),
						/* @__PURE__ */ jsx(SectionDivider, { label: "General" }),
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs(Panel, {
								...
								children: [/* @__PURE__ */ jsx(HorizontalBars, {
									...
									color: "#C711E1",
									height: 220
								}), /* @__PURE__ */ jsx(ChartInsight, { insight: dataset.insights?.sources })]
							}), /* @__PURE__ */ jsx(Panel, {
								...
								children: /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", { children: [
										/* @__PURE__ */ jsxs("div", {
											...
											children: ["Signal tier", /* @__PURE__ */ jsx("span", {
										...
										/* @__PURE__ */ jsx(ChartInsight, { insight: dataset.insights?.signal_tier })
									] }), /* @__PURE__ */ jsxs("div", { children: [
										/* @__PURE__ */ jsxs("div", {
											className: "eyebrow mb-2 flex items-center gap-1",
											children: ["Learning type", /* @__PURE__ */ jsx("span", {
										...
										/* @__PURE__ */ jsx(ChartInsight, { insight: dataset.insights?.learning_type })
									] })]
								})
							})]
						}),
						/* @__PURE__ */ jsxs(Panel, {
							...
							children: [/* @__PURE__ */ jsx(HorizontalBars, {
								data: providerCounts,
								color: "#7F52FF"
							}), /* @__PURE__ */ jsx(ChartInsight, { insight: dataset.insights?.top_providers })]
						}),
						...
						/* @__PURE__ */ jsxs(Panel, {
							...
							children: [
								...
								/* @__PURE__ */ jsx(ChartInsight, { insight: dataset.insights?.map }),
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("div", {
											className: "eyebrow text-[10px] sm:text-[11px]",
											children: ["University records", filters.countries.length > 0 && /* @__PURE__ */ jsxs("span", {
										...
										children: /* @__PURE__ */ jsx(DataTable, { data: mapRows })
									})]
								})
							]
						}),
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs(Panel, {
								...
								}), /* @__PURE__ */ jsx(ChartInsight, { insight: dataset.insights?.top_countries })]
							}), /* @__PURE__ */ jsx(Panel, {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Panel, {
								...
								children: /* @__PURE__ */ jsx(MoocCourseTable, { courses: moocCourses.map((c) => ({
									title: c.title,
									provider: c.provider,
									source: c.source,
									url: c.url
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs(Panel, {
								...
								children: [/* @__PURE__ */ jsx(HorizontalBars, {
									data: repoTypeCounts,
									color: "#7F52FF"
								}), /* @__PURE__ */ jsx(ChartInsight, { insight: dataset.insights?.github_types })]
							}), /* @__PURE__ */ jsx(Panel, {
						...
						/* @__PURE__ */ jsx(Panel, {
							...
							children: /* @__PURE__ */ jsx(GitHubRepoBars, { repos: topGitHubRepos.map((r) => ({
								title: r.title,
								url: r.url,
						...
						/* @__PURE__ */ jsxs(Panel, {
							...
							] }), /* @__PURE__ */ jsx(ChartInsight, { insight: dataset.insights?.baseline })]
						}),
						/* @__PURE__ */ jsxs("div", {
							className: "grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6",
							children: [/* @__PURE__ */ jsx(Panel, {
						...
						/* @__PURE__ */ jsx(Panel, {
							...
							children: /* @__PURE__ */ jsx(Suspense, {
								...
								children: /* @__PURE__ */ jsx(DataTable, { data: filtered })
							})
						})
					]
				})
