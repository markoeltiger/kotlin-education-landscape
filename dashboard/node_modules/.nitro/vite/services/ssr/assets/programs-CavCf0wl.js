...
import { t as Route } from "./programs-BBTZWlVw.js";
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("header", {
			...
			children: [
				...
				dataset.topics?.top_topics_by_country && Object.keys(dataset.topics.top_topics_by_country).length > 0 && /* @__PURE__ */ jsxs(Panel, {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs("select", {
							...
							}), Object.keys(dataset.topics.top_topics_by_country).sort().map((country) => /* @__PURE__ */ jsx("option", {
								value: country,
								children: country
							}, country))]
						})
					}), selectedCountry && dataset.topics.top_topics_by_country[selectedCountry] && /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(HorizontalBars, {
									...
									children: [
										...
										/* @__PURE__ */ jsx("td", {
											...
											children: /* @__PURE__ */ jsxs("div", {
												...
												children: [program.topics.slice(0, 3).map((topic) => /* @__PURE__ */ jsx("span", {
													...
													children: topic
												}, topic)), program.topics.length > 3 && /* @__PURE__ */ jsxs("span", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("span", {
										...
										children: sortedPrograms[expandedRow].topics.map((topic) => /* @__PURE__ */ jsx("span", {
											className: `inline-block px-2 py-0.5 rounded text-xs border ${getTopicColor(topic)}`,
