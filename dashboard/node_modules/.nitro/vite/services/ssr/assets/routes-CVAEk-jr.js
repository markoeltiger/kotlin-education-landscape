import { a as StackedBars, c as Panel, i as HorizontalBars, l as classNames, n as Funnel, o as useResizeObserver, r as Histogram, s as Empty, t as Donut, u as fmt } from "./Charts-Jm0x-9AT.js";
import { t as Route } from "./routes-C2tI9vhQ.js";
...
var DataTable = lazy(() => import("./DataTable-BYW0vW46.js").then((m) => ({ default: m.DataTable })));
...
function TopGitHubReposList({ repos }) {
	if (!repos.length) return /* @__PURE__ */ jsx(Empty, {});
				...
				/* @__PURE__ */ jsxs("main", {
					...
					children: [
						...
						/* @__PURE__ */ jsx(Panel, {
							...
							children: /* @__PURE__ */ jsx(TopGitHubReposList, { repos: topGitHubRepos })
						}),
						/* @__PURE__ */ jsx(SectionDivider, {
