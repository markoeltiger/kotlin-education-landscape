import { a as HorizontalBars, l as Empty, t as Donut, u as Panel } from "./Charts-Cg3e7Nay.js";
import { t as Route } from "./programs-B8lcqrGS.js";
...
function ProgramsPage() {
	...
	const setSearch = useCallback((updates) => {
		navigate({
			search: (prev) => ({
				...prev,
				...updates
	...
	if (!dataset?.programs?.length || !dataset?.topics) return /* @__PURE__ */ jsx("div", {
		className: "min-h-screen flex items-center justify-center",
		children: /* @__PURE__ */ jsx(Empty, { label: "Program data not available" })
	});
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("header", {
			...
			children: [
				...
				dataset?.topics?.top_targets_by_country && Object.keys(dataset.topics.top_targets_by_country).length > 0 && /* @__PURE__ */ jsxs(Panel, {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs("select", {
							...
							}), Object.keys(dataset.topics.top_targets_by_country).sort().map((country) => /* @__PURE__ */ jsx("option", {
								value: country,
								children: country
							}, country))]
						})
					}), selectedCountry && dataset.topics.top_targets_by_country[selectedCountry] && /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(HorizontalBars, {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
								...
								}), allCountries.map((country) => /* @__PURE__ */ jsx("option", {
									value: country,
									children: country
								}, country))]
							})] }),
							/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
								...
								children: [/* @__PURE__ */ jsx("option", {
									value: "",
									children: "All levels"
								}), allLevels.map((level) => /* @__PURE__ */ jsx("option", {
									value: level,
									children: level
								}, level))]
							})] }),
							/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
								...
								children: [/* @__PURE__ */ jsx("option", {
									value: "",
									children: "All topics"
								}), allTopics.map((topic) => /* @__PURE__ */ jsx("option", {
									value: topic,
									children: topic
								}, topic))]
							})] })
						]
					}), (search.search || search.country || search.level || search.topic) && /* @__PURE__ */ jsxs("div", {
						className: "mt-4 flex flex-wrap gap-2",
						children: [
							search.search && /* @__PURE__ */ jsxs("span", {
							...
							search.country && /* @__PURE__ */ jsxs("span", {
								className: "inline-flex items-center gap-1 px-2 py-1 rounded-md bg-kt-purple/20 text-kt-purple text-xs mono",
								children: [
									"Country: ",
									search.country,
							...
							search.level && /* @__PURE__ */ jsxs("span", {
								className: "inline-flex items-center gap-1 px-2 py-1 rounded-md bg-kt-purple/20 text-kt-purple text-xs mono",
								children: [
									"Level: ",
									search.level,
							...
							search.topic && /* @__PURE__ */ jsxs("span", {
								className: "inline-flex items-center gap-1 px-2 py-1 rounded-md bg-kt-purple/20 text-kt-purple text-xs mono",
								children: [
									"Topic: ",
									search.topic,
					...
					children: [
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs("table", {
								...
								}) }), /* @__PURE__ */ jsx("tbody", { children: sortedPrograms.map((program, index) => /* @__PURE__ */ jsxs("tr", {
									...
									children: [
										...
										/* @__PURE__ */ jsx("td", {
											...
											children: /* @__PURE__ */ jsxs("div", {
												...
												children: [(program.topics_canonical ?? program.topics ?? []).slice(0, 3).map((topic) => /* @__PURE__ */ jsx("span", {
													...
													children: topic
												}, topic)), (program.topics_canonical ?? program.topics ?? []).length > 3 && /* @__PURE__ */ jsxs("span", {
						...
						expandedRow !== null && sortedPrograms[expandedRow] && /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								sortedPrograms[expandedRow].prerequisites && /* @__PURE__ */ jsxs("div", {
									className: "text-sm",
									children: [/* @__PURE__ */ jsx("span", {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("span", {
										...
										children: (sortedPrograms[expandedRow].topics_canonical ?? sortedPrograms[expandedRow].topics ?? []).map((topic) => /* @__PURE__ */ jsx("span", {
											className: `inline-block px-2 py-0.5 rounded text-xs border ${getTopicColor(topic)}`,
						...
						sortedPrograms.length === 0 && /* @__PURE__ */ jsx(Empty, { label: "No programs match your filters" })
					]
				}),
				/* @__PURE__ */ jsx("div", {
